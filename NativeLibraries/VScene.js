...
async function importScene(p, db_files){
    ...
    //             if(f === null && !fs.existsSync(path.join(editor.project.dirname, name))){
    //                 fs.writeFileSync(path.join(editor.project.dirname, name), context);
    ...
    //                     LoadModel(path.join(editor.project.dirname, f.path), function(d){
    //                         f.data = d;
    //                     });
    //                     break;
    //                 }
    ...
    //                 case "image":{
    //                     f.data = new THREE.TextureLoader().load(path.join(editor.project.dirname, f.path));
    //                     f.data.name = f.name;
    //                     f.data["path"] = f.path;
    //                     f.data["EID"] = hash;
